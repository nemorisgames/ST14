...
$query = mysql_query("select a.Fecha, a.IdHistorial from Historial_Alumno a where a.IdAlumno  = \"" . $_POST["id"] . "\"")
or die("Error en la query" . mysql_error());
$salida="";
while($resultQuery = mysql_fetch_array($query)){
  $salida=$salida.$resultQuery['Fecha']."|".$resultQuery['IdHistorial']."*";
};
echo $salida;
?>